...
$result = $db->prepare("SELECT transaksi_pembelian_detail.id_pembelian_detail, transaksi_pembelian_detail.id_pembelian, transaksi_pembelian_detail.barcode_barang, transaksi_pembelian_detail.jml_beli, transaksi_pembelian_detail.keterangan, barang.nama_barang
						FROM transaksi_pembelian_detail INNER JOIN barang ON transaksi_pembelian_detail.barcode_barang = barang.barcode_barang ORDER BY transaksi_pembelian_detail.id_pembelian ");
$result->execute(); 
?>
<!doctype html>
<html>
                    ...
                    <table class="table table-striped data-tbl">
                        ...
                        <?php
                            for ($i = 0; $row = $result->fetch(); $i++) {
                                ...
                                # kolom jml_beli
                                echo "<td>" . ($row['jml_beli'] ? $row['jml_beli'] : "0") . "</td>";
                                # kolom keterangan
                                echo "<td>" . $row['keterangan'] . "</td>";
                                # kolom diterima
                                echo "<td class='td-center'>
                                <div class='btn-toolbar' role='toolbar'>
                                    <div class='btn-group' role='group' data-toggle='modal' data-target='#myModal' onclick='fokus_teks()' >
                                        <a class='btn btn-default btn-sm m-user-edit'><i class='zmdi zmdi-edit'></i></a>
										 <!-- Modal -->
											<div class='modal fade' id='myModal' role='dialog'>
												<div class='modal-dialog modal-lg'>
												<!-- Modal content-->
													<form action='tambah_keterangan.php' method='post' class='j-forms'>
														...
														<div class='modal-body'>
															<div class='unit'>
																<div class='input'>
																	...
																	<input class='form-control login-frm-input'  type='text' id='keterangan' name='keterangan' placeholder='Masukkan Keterangan' required='true'>
																</div>
															</div>
														</div>
									...
									<div class='btn-group' role='group'>
                                        <a href='edit.php?method=barcode&key=" . $row['id_pembelian_detail'] . "' class='btn btn-default btn-sm m-user-edit'><i class='zmdi zmdi-check'></i></a>
                                    </div>
								</div>
								</td>";
                            }
