...
$result = $db->prepare("SELECT barang.nama_barang, barang.barcode_barang, barang.jml_stok, barang.harga_beli, supplier.nama_supplier FROM barang 
						INNER JOIN supplier ON barang.id_supplier = supplier.id_supplier WHERE barang.jml_stok < 20 ORDER BY supplier.nama_supplier");
$result->execute(); 
?>
<!doctype html>
<html>
                    ...
                    <table class="table table-striped data-tbl">
                        ...
                        <?php
                            for ($i = 0; $row = $result->fetch(); $i++) {
                                ...
                                # kolom harga beli
                                echo "<td>" . ($row['harga_beli'] ? $row['harga_beli'] : "0") . "</td>";
                            }
                        ?>
